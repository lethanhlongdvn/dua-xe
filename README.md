...
### 1. Phiên bản Web (HTML/JS)
Đây là phiên bản dễ sử dụng nhất. Bạn chỉ cần:
- Mở file `index.html` ở thư mục gốc bằng bất kỳ trình duyệt web nào (Chrome, Edge, Firefox...).
- Giao diện trang chủ Cyberpunk sẽ hiện ra, cho phép bạn chọn trò chơi mong muốn.

### 2. Phiên bản Python (Pygame)
Nếu bạn muốn chạy bản Python, bạn cần cài đặt thư viện `pygame`:
```bash
pip install pygame
```
Sau đó, di chuyển vào từng thư mục trò chơi và chạy file `.py`:
```bash
python dua_xe_toan_hoc.py
```
...
---
*Phát triển bởi Đội ngũ Hỗ trợ Học tập.*
