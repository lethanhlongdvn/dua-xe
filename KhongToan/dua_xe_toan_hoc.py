...
pygame.display.set_caption("Đua Xe Toán Học - Chinh Phục 10 Thử Thách")
...
class Game:
    ...
    def draw(self):
        ...
        if self.state == "START":
            self.draw_text_centered("ĐUA XE TOÁN HỌC", self.font_bold, YELLOW, 400)
            ...
            lbl_title = self.font_bold.render(f"CHƯỚNG NGẠI VẬT {self.current_idx + 1}/10", True, YELLOW)
            ...
            lbl_win = self.font_bold.render("CHIẾN THẮNG RỰC RỠ! 🏆", True, YELLOW)
